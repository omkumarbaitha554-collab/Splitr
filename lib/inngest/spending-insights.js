...
export const spendingInsights = inngest.createFunction(
  ...
  async ({ step }) => {
    ...
    for (const user of users) {
      ...
      const prompt = `
As a financial analyst, review this user's spending data for the past month in INR and provide insightful observations and suggestions.
...
User spending data (all amounts in INR):
${expenseData}
