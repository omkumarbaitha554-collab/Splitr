  ...
  const expenseDatas = [
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 4254750.0, paid: true },
        { userId: user2._id, amount: 4254750.0, paid: false },
      ],
      createdBy: user1._id,
    },
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 18450.0, paid: false },
        { userId: user2._id, amount: 18450.0, paid: true },
      ],
      createdBy: user2._id,
    },
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user2._id, amount: 20500.0, paid: false },
        { userId: user3._id, amount: 20500.0, paid: true },
      ],
      createdBy: user3._id,
    },
    {
      ...
      splits: [
        { userId: user1._id, amount: 107693.7, paid: true }, // 70%
        { userId: user3._id, amount: 46141.3, paid: false }, // 30%
      ],
      createdBy: user1._id,
    },
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user2._id, amount: 49200.0, paid: true },
        { userId: user3._id, amount: 49200.0, paid: false },
      ],
      createdBy: user2._id,
    },
  ];
  ...
  const weekendTripExpenses = [
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 259666.67, paid: true },
        { userId: user2._id, amount: 259666.67, paid: false },
        { userId: user3._id, amount: 259666.66, paid: false },
      ],
    ...
    },
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 67020.5, paid: false },
        { userId: user2._id, amount: 67020.5, paid: true },
        { userId: user3._id, amount: 67020.5, paid: false },
      ],
      groupId: groups[0]._id, // Weekend Trip Group
      createdBy: user2._id,
    },
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 123000.0, paid: false },
        { userId: user2._id, amount: 123000.0, paid: false },
        { userId: user3._id, amount: 123000.0, paid: true },
      ],
      groupId: groups[0]._id, // Weekend Trip Group
      createdBy: user3._id,
    },
  ...
  const officeExpenses = [
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user2._id, amount: 34850.0, paid: true },
        { userId: user3._id, amount: 34850.0, paid: false },
      ],
    ...
    },
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user2._id, amount: 51266.4, paid: false },
        { userId: user3._id, amount: 51266.4, paid: true },
      ],
      groupId: groups[1]._id, // Office Expenses Group
      createdBy: user3._id,
    },
  ...
  const projectExpenses = [
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 32800.0, paid: false },
        { userId: user2._id, amount: 32800.0, paid: false },
        { userId: user3._id, amount: 32800.0, paid: true },
      ],
    ...
    },
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 98400.0, paid: true },
        { userId: user2._id, amount: 98400.0, paid: false },
        { userId: user3._id, amount: 98400.0, paid: false },
      ],
      groupId: groups[2]._id, // Project Alpha Group
      createdBy: user1._id,
    },
    {
      ...
      splitType: "percentage",
      splits: [
        { userId: user1._id, amount: 131216.4, paid: false }, // 33.33%
        { userId: user2._id, amount: 131216.4, paid: true }, // 33.33%
        { userId: user3._id, amount: 131216.4, paid: false }, // 33.33%
      ],
      groupId: groups[2]._id, // Project Alpha Group
      createdBy: user2._id,
    },
...
async function createSettlements(
  ...
  const settlementDatas = [
    ...
    {
      amount: 18450.0, // Amount user1 owes to user2
      note: "For cab ride",
      date: fiveDaysAgo,
    ...
    {
      amount: 259706.94, // Amount user2 owes to user1
      note: "Hotel payment",
      date: threeDaysAgo,
    ...
    {
      amount: 34850.0, // Amount user3 owes to user2
      note: "Office coffee",
